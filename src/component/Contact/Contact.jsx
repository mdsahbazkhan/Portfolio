...
function Contact() {
  ...
  return (
    <div id="Contact" className="contact flex flex-col items-center justify-center gap-10 sm:gap-10 md:gap-20 mx-2 sm:mx-4 md:mx-4 lg:mx-20 my-20">
      ...
      <div className="contact-section flex flex-col md:flex-row  sm:gap-20 md:gap-20 w-full px-4 items:center justify-center gap-8  md:w-auto">
        ...
        <form onSubmit={onSubmit} className="contact-right flex flex-col items-start gap-2 w-full ">
          <label className="text-gray-300 text-xl md:text-2xl font-semibold" htmlFor="name">Your Name</label>
          <input className="border-none h-12 md:h-16 w-full md:w-96 pl-4 bg-gray-800 text-xl md:text-2xl font-Outfit border border-white border-opacity-10 rounded-xl shadow-4xl  shadow-md backdrop-blur-lg" type="text" placeholder="Enter your name" name="name" />
          <label className="text-gray-300 text-xl md:text-2xl font-semibold" htmlFor="email">Your Email</label>
          <input className="border-none h-12 md:h-16 w-full md:w-96 pl-4 bg-gray-800 text-xl md:text-2xl font-Outfit border border-white border-opacity-10 rounded-xl shadow-4xl  shadow-md backdrop-blur-lg" type="email" placeholder="Enter your email" name="email" />
          <label className="text-gray-300 text-xl md:text-2xl font-semibold" htmlFor="message">Write your message here</label>
          <textarea className="w-full md:w-96 p-4  bg-gray-800 text-xl md:text-2xl font-Outfit border border-white border-opacity-10 rounded-xl shadow-4xl  shadow-md backdrop-blur-lg " name="message" placeholder="Enter your message" rows="6"></textarea>
          <button
             type="submit"
