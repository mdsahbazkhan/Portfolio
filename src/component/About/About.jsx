    ...
    <div className="about-right mt-10 md:mt-0 flex flex-col gap-10 ">
      <div className="about-para">
        <p className="text-base md:text-lg max-w-5xl">
          ...
          ratione, animi eos nostrum error illum quo iste voluptatem ab
          quaerat sapiente perspiciatis odio quibusdam laboriosam voluptates,
          distinctio aperiam libero excepturi?
        </p>
      </div>
      <div className="about-skills ">
        <div className="about-skill flex items-center gap-4 md:gap-6 lg:gap-12 mb-4 md:mb-6 lg:mb-8 transition duration-300 transform hover:scale-105 max-w ">
          ...
          <hr className="w-1/2 h-1 md:h-2 rounded-full bg-gradient-to-tr from-purple-600 to-orange-500" style={{ width: "50%" }} />
        </div>
