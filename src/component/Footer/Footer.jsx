...
export default function Footer() {
  return (
    <footer className="relative py-8 px-4 md:px-16 lg:px-24 text-white overflow-hidden">
      ...
      >
        ...
        <div className="flex gap-4 text-lg">
          <a
            ...
            className="p-3 bg-white/5 rounded-full hover:bg-cyan-500/30 hover:scale-110 transition-all duration-300"
          >
            <FaGithub />
          </a>
          <a
      ...
      >
        <span className="text-cyan-500">✦</span> Designed & Built by Md Sahbaz
        Alam <span className="text-cyan-500">✦</span>
      </motion.div>
    </footer>
  );
}
